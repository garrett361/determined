...
class APIHttpError(Exception):
    ...
    def __init__(self, operation_name: str, response: requests.Response) -> None:
        ...
        self.message = f"API Error: {operation_name} failed: {response.reason}."
...
class APIHttpStreamError(APIHttpError):
    ...
    def __init__(self, operation_name: str, error: "runtimeStreamError") -> None:
        self.operation_name = operation_name
        self.error = error
        self.message = f"Stream Error during {operation_name}: {error.message}"
...
class ResourcesSummaryDevices(Printable):
    ...
    def from_json(cls, obj: Json) -> "ResourcesSummaryDevices":
        ...
        if "devices" in obj:
            kwargs["devices"] = (
                [v1Device.from_json(x) for x in obj["devices"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "devices" in vars(self):
            out["devices"] = (
                None if self.devices is None else [x.to_json(omit_unset) for x in self.devices]
            )
        return out
...
class runtimeError(Printable):
    ...
    def from_json(cls, obj: Json) -> "runtimeError":
        ...
        if "details" in obj:
            kwargs["details"] = (
                [protobufAny.from_json(x) for x in obj["details"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "details" in vars(self):
            out["details"] = (
                None if self.details is None else [x.to_json(omit_unset) for x in self.details]
            )
...
class trialv1Trial(Printable):
    ...
    def from_json(cls, obj: Json) -> "trialv1Trial":
        ...
        if "bestCheckpoint" in obj:
            kwargs["bestCheckpoint"] = (
                v1CheckpointWorkload.from_json(obj["bestCheckpoint"])
                if obj["bestCheckpoint"] is not None
                else None
            )
        if "bestValidation" in obj:
            kwargs["bestValidation"] = (
                v1MetricsWorkload.from_json(obj["bestValidation"])
                if obj["bestValidation"] is not None
                else None
            )
        ...
        if "latestValidation" in obj:
            kwargs["latestValidation"] = (
                v1MetricsWorkload.from_json(obj["latestValidation"])
                if obj["latestValidation"] is not None
                else None
            )
        if "runnerState" in obj:
            kwargs["runnerState"] = obj["runnerState"]
        if "searcherMetricValue" in obj:
            kwargs["searcherMetricValue"] = (
                float(obj["searcherMetricValue"])
                if obj["searcherMetricValue"] is not None
                else None
            )
        ...
        if "wallClockTime" in obj:
            kwargs["wallClockTime"] = (
                float(obj["wallClockTime"]) if obj["wallClockTime"] is not None else None
            )
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "bestCheckpoint" in vars(self):
            out["bestCheckpoint"] = (
                None if self.bestCheckpoint is None else self.bestCheckpoint.to_json(omit_unset)
            )
        if not omit_unset or "bestValidation" in vars(self):
            out["bestValidation"] = (
                None if self.bestValidation is None else self.bestValidation.to_json(omit_unset)
            )
        ...
        if not omit_unset or "latestValidation" in vars(self):
            out["latestValidation"] = (
                None if self.latestValidation is None else self.latestValidation.to_json(omit_unset)
            )
        ...
        if not omit_unset or "searcherMetricValue" in vars(self):
            out["searcherMetricValue"] = (
                None if self.searcherMetricValue is None else dump_float(self.searcherMetricValue)
            )
        ...
        if not omit_unset or "wallClockTime" in vars(self):
            out["wallClockTime"] = (
                None if self.wallClockTime is None else dump_float(self.wallClockTime)
            )
...
class v1ActivateExperimentsRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ActivateExperimentsRequest":
        ...
        if "filters" in obj:
            kwargs["filters"] = (
                v1BulkExperimentFilters.from_json(obj["filters"])
...
class v1Agent(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Agent":
        ...
        if "containers" in obj:
            kwargs["containers"] = (
                {k: v1Container.from_json(v) for k, v in obj["containers"].items()}
                if obj["containers"] is not None
                else None
            )
        if "draining" in obj:
        ...
        if "slots" in obj:
            kwargs["slots"] = (
                {k: v1Slot.from_json(v) for k, v in obj["slots"].items()}
                if obj["slots"] is not None
                else None
            )
        if "version" in obj:
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "containers" in vars(self):
            out["containers"] = (
                ...
                else {k: v.to_json(omit_unset) for k, v in self.containers.items()}
            )
        ...
        if not omit_unset or "slots" in vars(self):
            out["slots"] = (
                ...
                else {k: v.to_json(omit_unset) for k, v in self.slots.items()}
            )
...
class v1AllocationSummary(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1AllocationSummary":
        ...
        if "proxyPorts" in obj:
            kwargs["proxyPorts"] = (
                [v1ProxyPortConfig.from_json(x) for x in obj["proxyPorts"]]
                if obj["proxyPorts"] is not None
                else None
            )
        if "registeredTime" in obj:
            kwargs["registeredTime"] = obj["registeredTime"]
        ...
        if "resources" in obj:
            kwargs["resources"] = (
                [v1ResourcesSummary.from_json(x) for x in obj["resources"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "proxyPorts" in vars(self):
            out["proxyPorts"] = (
                None
                if self.proxyPorts is None
                else [x.to_json(omit_unset) for x in self.proxyPorts]
            )
        if not omit_unset or "registeredTime" in vars(self):
            out["registeredTime"] = self.registeredTime
        ...
        if not omit_unset or "resources" in vars(self):
            out["resources"] = (
                None if self.resources is None else [x.to_json(omit_unset) for x in self.resources]
            )
...
class v1AssignRolesRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1AssignRolesRequest":
        ...
        if "groupRoleAssignments" in obj:
            kwargs["groupRoleAssignments"] = (
                [v1GroupRoleAssignment.from_json(x) for x in obj["groupRoleAssignments"]]
                if obj["groupRoleAssignments"] is not None
                else None
            )
        if "userRoleAssignments" in obj:
            kwargs["userRoleAssignments"] = (
                [v1UserRoleAssignment.from_json(x) for x in obj["userRoleAssignments"]]
                if obj["userRoleAssignments"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "groupRoleAssignments" in vars(self):
            out["groupRoleAssignments"] = (
                None
                if self.groupRoleAssignments is None
                else [x.to_json(omit_unset) for x in self.groupRoleAssignments]
            )
        if not omit_unset or "userRoleAssignments" in vars(self):
            out["userRoleAssignments"] = (
                None
                if self.userRoleAssignments is None
                else [x.to_json(omit_unset) for x in self.userRoleAssignments]
            )
        return out
...
class v1BulkExperimentFilters(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1BulkExperimentFilters":
        ...
        if "states" in obj:
            kwargs["states"] = (
                [experimentv1State(x) for x in obj["states"]] if obj["states"] is not None else None
            )
        if "userIds" in obj:
...
class v1CheckpointTrainingMetadata(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1CheckpointTrainingMetadata":
        ...
        if "searcherMetric" in obj:
            kwargs["searcherMetric"] = (
                float(obj["searcherMetric"]) if obj["searcherMetric"] is not None else None
            )
        if "trainingMetrics" in obj:
            kwargs["trainingMetrics"] = (
                v1Metrics.from_json(obj["trainingMetrics"])
                if obj["trainingMetrics"] is not None
                else None
            )
        if "trialId" in obj:
            kwargs["trialId"] = obj["trialId"]
        if "validationMetrics" in obj:
            kwargs["validationMetrics"] = (
                v1Metrics.from_json(obj["validationMetrics"])
                if obj["validationMetrics"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "searcherMetric" in vars(self):
            out["searcherMetric"] = (
                None if self.searcherMetric is None else dump_float(self.searcherMetric)
            )
        if not omit_unset or "trainingMetrics" in vars(self):
            out["trainingMetrics"] = (
                None if self.trainingMetrics is None else self.trainingMetrics.to_json(omit_unset)
            )
        ...
        if not omit_unset or "validationMetrics" in vars(self):
            out["validationMetrics"] = (
                None
                if self.validationMetrics is None
                else self.validationMetrics.to_json(omit_unset)
            )
        return out
...
class v1Command(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Command":
        ...
        if "container" in obj:
            kwargs["container"] = (
                v1Container.from_json(obj["container"]) if obj["container"] is not None else None
            )
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "container" in vars(self):
            out["container"] = (
                None if self.container is None else self.container.to_json(omit_unset)
            )
...
class v1CompleteValidateAfterOperation(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1CompleteValidateAfterOperation":
        ...
        if "op" in obj:
            kwargs["op"] = (
                v1ValidateAfterOperation.from_json(obj["op"]) if obj["op"] is not None else None
            )
        if "searcherMetric" in obj:
...
class v1CreateExperimentRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1CreateExperimentRequest":
        ...
        if "modelDefinition" in obj:
            kwargs["modelDefinition"] = (
                [v1File.from_json(x) for x in obj["modelDefinition"]]
                if obj["modelDefinition"] is not None
                else None
            )
        if "parentId" in obj:
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "modelDefinition" in vars(self):
            out["modelDefinition"] = (
                ...
                else [x.to_json(omit_unset) for x in self.modelDefinition]
            )
...
class v1CreateExperimentResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1CreateExperimentResponse":
        ...
        if "warnings" in obj:
            kwargs["warnings"] = (
                [v1LaunchWarning(x) for x in obj["warnings"]]
...
class v1ExpMetricNamesResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ExpMetricNamesResponse":
        ...
        if "metricNames" in obj:
            kwargs["metricNames"] = (
                [v1MetricIdentifier.from_json(x) for x in obj["metricNames"]]
                if obj["metricNames"] is not None
                else None
            )
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "metricNames" in vars(self):
            out["metricNames"] = (
                None
                if self.metricNames is None
                else [x.to_json(omit_unset) for x in self.metricNames]
            )
...
class v1Experiment(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Experiment":
        ...
        if "bestTrialSearcherMetric" in obj:
            kwargs["bestTrialSearcherMetric"] = (
                float(obj["bestTrialSearcherMetric"])
                if obj["bestTrialSearcherMetric"] is not None
                else None
            )
        if "checkpointCount" in obj:
            kwargs["checkpointCount"] = obj["checkpointCount"]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "bestTrialSearcherMetric" in vars(self):
            out["bestTrialSearcherMetric"] = (
                None
                if self.bestTrialSearcherMetric is None
                else dump_float(self.bestTrialSearcherMetric)
            )
        if not omit_unset or "checkpointCount" in vars(self):
            out["checkpointCount"] = self.checkpointCount
...
class v1ExperimentSimulation(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ExperimentSimulation":
        ...
        if "trials" in obj:
            kwargs["trials"] = (
                [v1TrialSimulation.from_json(x) for x in obj["trials"]]
                if obj["trials"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "trials" in vars(self):
            out["trials"] = (
                None if self.trials is None else [x.to_json(omit_unset) for x in self.trials]
            )
        return out
...
class v1FileNode(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1FileNode":
        ...
        if "files" in obj:
            kwargs["files"] = (
                [v1FileNode.from_json(x) for x in obj["files"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "files" in vars(self):
            out["files"] = (
                None if self.files is None else [x.to_json(omit_unset) for x in self.files]
            )
...
class v1GetAgentsResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetAgentsResponse":
        ...
        if "pagination" in obj:
            kwargs["pagination"] = (
                v1Pagination.from_json(obj["pagination"]) if obj["pagination"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "pagination" in vars(self):
            out["pagination"] = (
                None if self.pagination is None else self.pagination.to_json(omit_unset)
            )
        return out
...
class v1GetExperimentResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetExperimentResponse":
        ...
        if "jobSummary" in obj:
            kwargs["jobSummary"] = (
                v1JobSummary.from_json(obj["jobSummary"]) if obj["jobSummary"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "jobSummary" in vars(self):
            out["jobSummary"] = (
                None if self.jobSummary is None else self.jobSummary.to_json(omit_unset)
            )
        return out
...
class v1GetExperimentValidationHistoryResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetExperimentValidationHistoryResponse":
        ...
        if "validationHistory" in obj:
            kwargs["validationHistory"] = (
                [v1ValidationHistoryEntry.from_json(x) for x in obj["validationHistory"]]
                if obj["validationHistory"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "validationHistory" in vars(self):
            out["validationHistory"] = (
                None
                if self.validationHistory is None
                else [x.to_json(omit_unset) for x in self.validationHistory]
            )
        return out
...
class v1GetGroupsResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetGroupsResponse":
        ...
        if "groups" in obj:
            kwargs["groups"] = (
                [v1GroupSearchResult.from_json(x) for x in obj["groups"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "groups" in vars(self):
            out["groups"] = (
                None if self.groups is None else [x.to_json(omit_unset) for x in self.groups]
            )
        if not omit_unset or "pagination" in vars(self):
            out["pagination"] = (
                None if self.pagination is None else self.pagination.to_json(omit_unset)
...
class v1GetMasterResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetMasterResponse":
        ...
        if "product" in obj:
            kwargs["product"] = (
                GetMasterResponseProduct(obj["product"]) if obj["product"] is not None else None
            )
        if "rbacEnabled" in obj:
            kwargs["rbacEnabled"] = obj["rbacEnabled"]
        if "ssoProviders" in obj:
            kwargs["ssoProviders"] = (
                [v1SSOProvider.from_json(x) for x in obj["ssoProviders"]]
                if obj["ssoProviders"] is not None
                else None
            )
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "ssoProviders" in vars(self):
            out["ssoProviders"] = (
                None
                if self.ssoProviders is None
                else [x.to_json(omit_unset) for x in self.ssoProviders]
            )
...
class v1GetProjectNumericMetricsRangeResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetProjectNumericMetricsRangeResponse":
        ...
        if "ranges" in obj:
            kwargs["ranges"] = (
                [v1MetricsRange.from_json(x) for x in obj["ranges"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "ranges" in vars(self):
            out["ranges"] = (
                None if self.ranges is None else [x.to_json(omit_unset) for x in self.ranges]
            )
        return out
...
class v1GetProjectsByUserActivityResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetProjectsByUserActivityResponse":
        ...
        if "projects" in obj:
            kwargs["projects"] = (
                [v1Project.from_json(x) for x in obj["projects"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "projects" in vars(self):
            out["projects"] = (
                None if self.projects is None else [x.to_json(omit_unset) for x in self.projects]
            )
        return out
...
class v1GetResourcePoolsResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetResourcePoolsResponse":
        ...
        if "resourcePools" in obj:
            kwargs["resourcePools"] = (
                [v1ResourcePool.from_json(x) for x in obj["resourcePools"]]
                if obj["resourcePools"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "resourcePools" in vars(self):
            out["resourcePools"] = (
                None
                if self.resourcePools is None
                else [x.to_json(omit_unset) for x in self.resourcePools]
            )
        return out
...
class v1GetRolesByIDResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetRolesByIDResponse":
        ...
        if "roles" in obj:
            kwargs["roles"] = (
                [v1RoleWithAssignments.from_json(x) for x in obj["roles"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "roles" in vars(self):
            out["roles"] = (
                None if self.roles is None else [x.to_json(omit_unset) for x in self.roles]
            )
        return out
...
class v1GetSearcherEventsResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetSearcherEventsResponse":
        ...
        if "searcherEvents" in obj:
            kwargs["searcherEvents"] = (
                [v1SearcherEvent.from_json(x) for x in obj["searcherEvents"]]
                if obj["searcherEvents"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "searcherEvents" in vars(self):
            out["searcherEvents"] = (
                None
                if self.searcherEvents is None
                else [x.to_json(omit_unset) for x in self.searcherEvents]
            )
        return out
...
class v1GetSlotsResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetSlotsResponse":
        ...
        if "slots" in obj:
            kwargs["slots"] = (
                [v1Slot.from_json(x) for x in obj["slots"]] if obj["slots"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "slots" in vars(self):
            out["slots"] = (
                None if self.slots is None else [x.to_json(omit_unset) for x in self.slots]
            )
        return out
...
class v1GetTasksResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetTasksResponse":
        ...
        if "allocationIdToSummary" in obj:
            kwargs["allocationIdToSummary"] = (
                {
                    k: v1AllocationSummary.from_json(v)
                    for k, v in obj["allocationIdToSummary"].items()
                }
                if obj["allocationIdToSummary"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "allocationIdToSummary" in vars(self):
            out["allocationIdToSummary"] = (
                None
                if self.allocationIdToSummary is None
                else {k: v.to_json(omit_unset) for k, v in self.allocationIdToSummary.items()}
            )
        return out
...
class v1GetUsersResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1GetUsersResponse":
        ...
        if "users" in obj:
            kwargs["users"] = (
                [v1User.from_json(x) for x in obj["users"]] if obj["users"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "users" in vars(self):
            out["users"] = (
                None if self.users is None else [x.to_json(omit_unset) for x in self.users]
            )
        return out
...
class v1Job(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Job":
        ...
        if "summary" in obj:
            kwargs["summary"] = (
                v1JobSummary.from_json(obj["summary"]) if obj["summary"] is not None else None
            )
        if "userId" in obj:
            kwargs["userId"] = obj["userId"]
        if "weight" in obj:
...
class v1KillCommandResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1KillCommandResponse":
        ...
        if "command" in obj:
            kwargs["command"] = (
                v1Command.from_json(obj["command"]) if obj["command"] is not None else None
            )
        return cls(**kwargs)
...
class v1KillNotebookResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1KillNotebookResponse":
        ...
        if "notebook" in obj:
            kwargs["notebook"] = (
                v1Notebook.from_json(obj["notebook"]) if obj["notebook"] is not None else None
            )
        return cls(**kwargs)
...
class v1KillTensorboardResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1KillTensorboardResponse":
        ...
        if "tensorboard" in obj:
            kwargs["tensorboard"] = (
                v1Tensorboard.from_json(obj["tensorboard"])
                if obj["tensorboard"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "tensorboard" in vars(self):
            out["tensorboard"] = (
                None if self.tensorboard is None else self.tensorboard.to_json(omit_unset)
            )
        return out
...
class v1LaunchCommandRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1LaunchCommandRequest":
        ...
        if "files" in obj:
            kwargs["files"] = (
                [v1File.from_json(x) for x in obj["files"]] if obj["files"] is not None else None
            )
...
class v1PatchCheckpoint(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PatchCheckpoint":
        ...
        if "resources" in obj:
            kwargs["resources"] = (
                PatchCheckpointOptionalResources.from_json(obj["resources"])
                if obj["resources"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "resources" in vars(self):
            out["resources"] = (
                None if self.resources is None else self.resources.to_json(omit_unset)
            )
        return out
...
class v1PatchExperiment(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PatchExperiment":
        ...
        if "checkpointStorage" in obj:
            kwargs["checkpointStorage"] = (
                PatchExperimentPatchCheckpointStorage.from_json(obj["checkpointStorage"])
                if obj["checkpointStorage"] is not None
                else None
            )
        if "description" in obj:
            kwargs["description"] = obj["description"]
        ...
        if "resources" in obj:
            kwargs["resources"] = (
                PatchExperimentPatchResources.from_json(obj["resources"])
                if obj["resources"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "checkpointStorage" in vars(self):
            out["checkpointStorage"] = (
                None
                if self.checkpointStorage is None
                else self.checkpointStorage.to_json(omit_unset)
            )
        if not omit_unset or "description" in vars(self):
            out["description"] = self.description
        if not omit_unset or "labels" in vars(self):
...
class v1PatchExperimentResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PatchExperimentResponse":
        ...
        if "experiment" in obj:
            kwargs["experiment"] = (
                v1Experiment.from_json(obj["experiment"]) if obj["experiment"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "experiment" in vars(self):
            out["experiment"] = (
                None if self.experiment is None else self.experiment.to_json(omit_unset)
            )
        return out
...
class v1PatchMasterConfigRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PatchMasterConfigRequest":
        ...
        if "config" in obj:
            kwargs["config"] = (
                v1Config.from_json(obj["config"]) if obj["config"] is not None else None
            )
        if "fieldMask" in obj:
            kwargs["fieldMask"] = (
                protobufFieldMask.from_json(obj["fieldMask"])
                if obj["fieldMask"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "fieldMask" in vars(self):
            out["fieldMask"] = (
                None if self.fieldMask is None else self.fieldMask.to_json(omit_unset)
            )
        return out
...
class v1PatchModelVersion(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PatchModelVersion":
        ...
        if "checkpoint" in obj:
            kwargs["checkpoint"] = (
                v1Checkpoint.from_json(obj["checkpoint"]) if obj["checkpoint"] is not None else None
            )
        if "comment" in obj:
            kwargs["comment"] = obj["comment"]
        if "labels" in obj:
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "checkpoint" in vars(self):
            out["checkpoint"] = (
                None if self.checkpoint is None else self.checkpoint.to_json(omit_unset)
            )
        if not omit_unset or "comment" in vars(self):
            out["comment"] = self.comment
        if not omit_unset or "labels" in vars(self):
...
class v1PatchUser(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PatchUser":
        ...
        if "agentUserGroup" in obj:
            kwargs["agentUserGroup"] = (
                v1AgentUserGroup.from_json(obj["agentUserGroup"])
                if obj["agentUserGroup"] is not None
                else None
            )
        if "displayName" in obj:
            kwargs["displayName"] = obj["displayName"]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "agentUserGroup" in vars(self):
            out["agentUserGroup"] = (
                None if self.agentUserGroup is None else self.agentUserGroup.to_json(omit_unset)
            )
        if not omit_unset or "displayName" in vars(self):
            out["displayName"] = self.displayName
        if not omit_unset or "isHashed" in vars(self):
...
class v1Permission(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Permission":
        ...
        if "scopeTypeMask" in obj:
            kwargs["scopeTypeMask"] = (
                v1ScopeTypeMask.from_json(obj["scopeTypeMask"])
                if obj["scopeTypeMask"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "scopeTypeMask" in vars(self):
            out["scopeTypeMask"] = (
                None if self.scopeTypeMask is None else self.scopeTypeMask.to_json(omit_unset)
            )
        return out
...
class v1PermissionType(DetEnum):
    ...
    SET_WORKSPACE_CHECKPOINT_STORAGE_CONFIG = (
...
class v1PolymorphicFilter(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PolymorphicFilter":
        ...
        if "doubleRange" in obj:
            kwargs["doubleRange"] = (
                v1DoubleFieldFilter.from_json(obj["doubleRange"])
                if obj["doubleRange"] is not None
                else None
            )
        if "integerRange" in obj:
            kwargs["integerRange"] = (
                v1Int32FieldFilter.from_json(obj["integerRange"])
                if obj["integerRange"] is not None
                else None
            )
        if "name" in obj:
            kwargs["name"] = obj["name"]
        if "timeRange" in obj:
            kwargs["timeRange"] = (
                v1TimestampFieldFilter.from_json(obj["timeRange"])
                if obj["timeRange"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "doubleRange" in vars(self):
            out["doubleRange"] = (
                None if self.doubleRange is None else self.doubleRange.to_json(omit_unset)
            )
        if not omit_unset or "integerRange" in vars(self):
            out["integerRange"] = (
                None if self.integerRange is None else self.integerRange.to_json(omit_unset)
            )
        if not omit_unset or "name" in vars(self):
            out["name"] = self.name
        if not omit_unset or "timeRange" in vars(self):
            out["timeRange"] = (
                None if self.timeRange is None else self.timeRange.to_json(omit_unset)
            )
        return out
...
class v1PostSearcherOperationsRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PostSearcherOperationsRequest":
        ...
        if "searcherOperations" in obj:
            kwargs["searcherOperations"] = (
                [v1SearcherOperation.from_json(x) for x in obj["searcherOperations"]]
                if obj["searcherOperations"] is not None
                else None
            )
        if "triggeredByEvent" in obj:
            kwargs["triggeredByEvent"] = (
                v1SearcherEvent.from_json(obj["triggeredByEvent"])
                if obj["triggeredByEvent"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "searcherOperations" in vars(self):
            out["searcherOperations"] = (
                None
                if self.searcherOperations is None
                else [x.to_json(omit_unset) for x in self.searcherOperations]
            )
        if not omit_unset or "triggeredByEvent" in vars(self):
            out["triggeredByEvent"] = (
                None if self.triggeredByEvent is None else self.triggeredByEvent.to_json(omit_unset)
            )
        return out
...
class v1PostTrialProfilerMetricsBatchRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PostTrialProfilerMetricsBatchRequest":
        ...
        if "batches" in obj:
            kwargs["batches"] = (
                [v1TrialProfilerMetricsBatch.from_json(x) for x in obj["batches"]]
                if obj["batches"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "batches" in vars(self):
            out["batches"] = (
                None if self.batches is None else [x.to_json(omit_unset) for x in self.batches]
            )
        return out
...
class v1PreviewHPSearchResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PreviewHPSearchResponse":
        ...
        if "simulation" in obj:
            kwargs["simulation"] = (
                v1ExperimentSimulation.from_json(obj["simulation"])
                if obj["simulation"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "simulation" in vars(self):
            out["simulation"] = (
                None if self.simulation is None else self.simulation.to_json(omit_unset)
            )
        return out
...
class v1PutTemplateResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PutTemplateResponse":
        ...
        if "template" in obj:
            kwargs["template"] = (
                v1Template.from_json(obj["template"]) if obj["template"] is not None else None
            )
        return cls(**kwargs)
...
class v1PutTrialRequest(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1PutTrialRequest":
        ...
        if "createTrialRequest" in obj:
            kwargs["createTrialRequest"] = (
                v1CreateTrialRequest.from_json(obj["createTrialRequest"])
                if obj["createTrialRequest"] is not None
                else None
            )
        if "externalTrialId" in obj:
            kwargs["externalTrialId"] = obj["externalTrialId"]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "createTrialRequest" in vars(self):
            out["createTrialRequest"] = (
                None
                if self.createTrialRequest is None
                else self.createTrialRequest.to_json(omit_unset)
            )
        if not omit_unset or "externalTrialId" in vars(self):
            out["externalTrialId"] = self.externalTrialId
        return out
...
class v1RBACJob(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1RBACJob":
        ...
        if "limited" in obj:
            kwargs["limited"] = (
                v1LimitedJob.from_json(obj["limited"]) if obj["limited"] is not None else None
            )
        return cls(**kwargs)
...
class v1RPQueueStat(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1RPQueueStat":
        ...
        if "aggregates" in obj:
            kwargs["aggregates"] = (
                [v1AggregateQueueStats.from_json(x) for x in obj["aggregates"]]
                if obj["aggregates"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "aggregates" in vars(self):
            out["aggregates"] = (
                ...
                else [x.to_json(omit_unset) for x in self.aggregates]
            )
        return out
...
class v1ResourceAllocationAggregatedResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourceAllocationAggregatedResponse":
        kwargs: "typing.Dict[str, typing.Any]" = {
            "resourceEntries": [
                v1ResourceAllocationAggregatedEntry.from_json(x) for x in obj["resourceEntries"]
            ],
        }
        return cls(**kwargs)
...
class v1ResourceAllocationRawResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourceAllocationRawResponse":
        ...
        if "resourceEntries" in obj:
            kwargs["resourceEntries"] = (
                [v1ResourceAllocationRawEntry.from_json(x) for x in obj["resourceEntries"]]
                if obj["resourceEntries"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "resourceEntries" in vars(self):
            out["resourceEntries"] = (
                None
                if self.resourceEntries is None
                else [x.to_json(omit_unset) for x in self.resourceEntries]
            )
        return out
...
class v1ResourcePool(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcePool":
        ...
        if "stats" in obj:
            kwargs["stats"] = (
                v1QueueStats.from_json(obj["stats"]) if obj["stats"] is not None else None
            )
        return cls(**kwargs)
...
class v1ResourcePoolAwsDetail(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcePoolAwsDetail":
        ...
        if "customTags" in obj:
            kwargs["customTags"] = (
                [v1AwsCustomTag.from_json(x) for x in obj["customTags"]]
                if obj["customTags"] is not None
                else None
            )
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "customTags" in vars(self):
            out["customTags"] = (
                None
                if self.customTags is None
                else [x.to_json(omit_unset) for x in self.customTags]
            )
...
class v1ResourcePoolDetail(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcePoolDetail":
        ...
        if "aws" in obj:
            kwargs["aws"] = (
                v1ResourcePoolAwsDetail.from_json(obj["aws"]) if obj["aws"] is not None else None
            )
        if "gcp" in obj:
            kwargs["gcp"] = (
                v1ResourcePoolGcpDetail.from_json(obj["gcp"]) if obj["gcp"] is not None else None
            )
        if "priorityScheduler" in obj:
            kwargs["priorityScheduler"] = (
                v1ResourcePoolPrioritySchedulerDetail.from_json(obj["priorityScheduler"])
                if obj["priorityScheduler"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "priorityScheduler" in vars(self):
            out["priorityScheduler"] = (
                None
                if self.priorityScheduler is None
                else self.priorityScheduler.to_json(omit_unset)
            )
        return out
...
class v1ResourcePoolPrioritySchedulerDetail(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcePoolPrioritySchedulerDetail":
        ...
        if "k8Priorities" in obj:
            kwargs["k8Priorities"] = (
                [v1K8PriorityClass.from_json(x) for x in obj["k8Priorities"]]
                if obj["k8Priorities"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "k8Priorities" in vars(self):
            out["k8Priorities"] = (
                None
                if self.k8Priorities is None
                else [x.to_json(omit_unset) for x in self.k8Priorities]
            )
        return out
...
class v1ResourcesFailure(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcesFailure":
        ...
        if "failureType" in obj:
            kwargs["failureType"] = (
                v1FailureType(obj["failureType"]) if obj["failureType"] is not None else None
            )
        return cls(**kwargs)
...
class v1ResourcesStarted(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcesStarted":
        ...
        if "addresses" in obj:
            kwargs["addresses"] = (
                [v1Address.from_json(x) for x in obj["addresses"]]
                if obj["addresses"] is not None
                else None
            )
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "addresses" in vars(self):
            out["addresses"] = (
                None if self.addresses is None else [x.to_json(omit_unset) for x in self.addresses]
            )
...
class v1ResourcesStopped(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcesStopped":
        ...
        if "failure" in obj:
            kwargs["failure"] = (
                v1ResourcesFailure.from_json(obj["failure"]) if obj["failure"] is not None else None
            )
        return cls(**kwargs)
...
class v1ResourcesSummary(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1ResourcesSummary":
        ...
        if "agentDevices" in obj:
            kwargs["agentDevices"] = (
                {k: ResourcesSummaryDevices.from_json(v) for k, v in obj["agentDevices"].items()}
                if obj["agentDevices"] is not None
                else None
            )
        if "allocationId" in obj:
            kwargs["allocationId"] = obj["allocationId"]
        ...
        if "exited" in obj:
            kwargs["exited"] = (
                v1ResourcesStopped.from_json(obj["exited"]) if obj["exited"] is not None else None
            )
        if "resourcesId" in obj:
            kwargs["resourcesId"] = obj["resourcesId"]
        ...
        if "started" in obj:
            kwargs["started"] = (
                v1ResourcesStarted.from_json(obj["started"]) if obj["started"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "agentDevices" in vars(self):
            out["agentDevices"] = (
                None
                if self.agentDevices is None
                else {k: v.to_json(omit_unset) for k, v in self.agentDevices.items()}
            )
        if not omit_unset or "allocationId" in vars(self):
            out["allocationId"] = self.allocationId
        if not omit_unset or "containerId" in vars(self):
...
class v1Role(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Role":
        ...
        if "permissions" in obj:
            kwargs["permissions"] = (
                [v1Permission.from_json(x) for x in obj["permissions"]]
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "permissions" in vars(self):
            out["permissions"] = (
                ...
                else [x.to_json(omit_unset) for x in self.permissions]
            )
        if not omit_unset or "scopeTypeMask" in vars(self):
            out["scopeTypeMask"] = (
                None if self.scopeTypeMask is None else self.scopeTypeMask.to_json(omit_unset)
...
class v1SearchExperimentExperiment(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1SearchExperimentExperiment":
        ...
        if "bestTrial" in obj:
            kwargs["bestTrial"] = (
                trialv1Trial.from_json(obj["bestTrial"]) if obj["bestTrial"] is not None else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "bestTrial" in vars(self):
            out["bestTrial"] = (
                None if self.bestTrial is None else self.bestTrial.to_json(omit_unset)
            )
        return out
...
class v1SearchRolesAssignableToScopeResponse(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1SearchRolesAssignableToScopeResponse":
        ...
        if "roles" in obj:
            kwargs["roles"] = (
                [v1Role.from_json(x) for x in obj["roles"]] if obj["roles"] is not None else None
            )
        return cls(**kwargs)
...
class v1SearcherEvent(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1SearcherEvent":
        ...
        if "experimentInactive" in obj:
            kwargs["experimentInactive"] = (
                v1ExperimentInactive.from_json(obj["experimentInactive"])
                if obj["experimentInactive"] is not None
                else None
            )
        if "initialOperations" in obj:
            kwargs["initialOperations"] = (
                v1InitialOperations.from_json(obj["initialOperations"])
                if obj["initialOperations"] is not None
                else None
            )
        if "trialClosed" in obj:
            kwargs["trialClosed"] = (
                v1TrialClosed.from_json(obj["trialClosed"])
                if obj["trialClosed"] is not None
                else None
            )
        if "trialCreated" in obj:
            kwargs["trialCreated"] = (
                v1TrialCreated.from_json(obj["trialCreated"])
                if obj["trialCreated"] is not None
                else None
            )
        if "trialExitedEarly" in obj:
            kwargs["trialExitedEarly"] = (
                v1TrialExitedEarly.from_json(obj["trialExitedEarly"])
                if obj["trialExitedEarly"] is not None
                else None
            )
        if "trialProgress" in obj:
            kwargs["trialProgress"] = (
                v1TrialProgress.from_json(obj["trialProgress"])
                if obj["trialProgress"] is not None
                else None
            )
        if "validationCompleted" in obj:
            kwargs["validationCompleted"] = (
                v1ValidationCompleted.from_json(obj["validationCompleted"])
                if obj["validationCompleted"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "experimentInactive" in vars(self):
            out["experimentInactive"] = (
                None
                if self.experimentInactive is None
                else self.experimentInactive.to_json(omit_unset)
            )
        if not omit_unset or "initialOperations" in vars(self):
            out["initialOperations"] = (
                None
                if self.initialOperations is None
                else self.initialOperations.to_json(omit_unset)
            )
        if not omit_unset or "trialClosed" in vars(self):
            out["trialClosed"] = (
                None if self.trialClosed is None else self.trialClosed.to_json(omit_unset)
            )
        if not omit_unset or "trialCreated" in vars(self):
            out["trialCreated"] = (
                None if self.trialCreated is None else self.trialCreated.to_json(omit_unset)
            )
        if not omit_unset or "trialExitedEarly" in vars(self):
            out["trialExitedEarly"] = (
                None if self.trialExitedEarly is None else self.trialExitedEarly.to_json(omit_unset)
            )
        if not omit_unset or "trialProgress" in vars(self):
            out["trialProgress"] = (
                None if self.trialProgress is None else self.trialProgress.to_json(omit_unset)
            )
        if not omit_unset or "validationCompleted" in vars(self):
            out["validationCompleted"] = (
                None
                if self.validationCompleted is None
                else self.validationCompleted.to_json(omit_unset)
            )
        return out
...
class v1SearcherOperation(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1SearcherOperation":
        ...
        if "closeTrial" in obj:
            kwargs["closeTrial"] = (
                v1CloseTrialOperation.from_json(obj["closeTrial"])
                if obj["closeTrial"] is not None
                else None
            )
        if "createTrial" in obj:
            kwargs["createTrial"] = (
                v1CreateTrialOperation.from_json(obj["createTrial"])
                if obj["createTrial"] is not None
                else None
            )
        if "setSearcherProgress" in obj:
            kwargs["setSearcherProgress"] = (
                v1SetSearcherProgressOperation.from_json(obj["setSearcherProgress"])
                if obj["setSearcherProgress"] is not None
                else None
            )
        if "shutDown" in obj:
            kwargs["shutDown"] = (
                v1ShutDownOperation.from_json(obj["shutDown"])
                if obj["shutDown"] is not None
                else None
            )
        if "trialOperation" in obj:
            kwargs["trialOperation"] = (
                v1TrialOperation.from_json(obj["trialOperation"])
                if obj["trialOperation"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "closeTrial" in vars(self):
            out["closeTrial"] = (
                None if self.closeTrial is None else self.closeTrial.to_json(omit_unset)
            )
        if not omit_unset or "createTrial" in vars(self):
            out["createTrial"] = (
                None if self.createTrial is None else self.createTrial.to_json(omit_unset)
            )
        if not omit_unset or "setSearcherProgress" in vars(self):
            out["setSearcherProgress"] = (
                None
                if self.setSearcherProgress is None
                else self.setSearcherProgress.to_json(omit_unset)
            )
        ...
        if not omit_unset or "trialOperation" in vars(self):
            out["trialOperation"] = (
                None if self.trialOperation is None else self.trialOperation.to_json(omit_unset)
            )
        return out
...
class v1Slot(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Slot":
        ...
        if "device" in obj:
            kwargs["device"] = (
                v1Device.from_json(obj["device"]) if obj["device"] is not None else None
            )
        if "draining" in obj:
            kwargs["draining"] = obj["draining"]
        if "enabled" in obj:
...
class v1TrialOperation(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1TrialOperation":
        ...
        if "validateAfter" in obj:
            kwargs["validateAfter"] = (
                v1ValidateAfterOperation.from_json(obj["validateAfter"])
                if obj["validateAfter"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "validateAfter" in vars(self):
            out["validateAfter"] = (
                None if self.validateAfter is None else self.validateAfter.to_json(omit_unset)
            )
        return out
...
class v1TrialProfilerMetricLabels(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1TrialProfilerMetricLabels":
        ...
        if "metricType" in obj:
            kwargs["metricType"] = (
                TrialProfilerMetricLabelsProfilerMetricType(obj["metricType"])
                if obj["metricType"] is not None
                else None
            )
        return cls(**kwargs)
...
class v1TrialSimulation(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1TrialSimulation":
        ...
        if "operations" in obj:
            kwargs["operations"] = (
                [v1RunnableOperation.from_json(x) for x in obj["operations"]]
                if obj["operations"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "operations" in vars(self):
            out["operations"] = (
                ...
                else [x.to_json(omit_unset) for x in self.operations]
            )
        return out
...
class v1Trigger(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Trigger":
        ...
        if "triggerType" in obj:
            kwargs["triggerType"] = (
                v1TriggerType(obj["triggerType"]) if obj["triggerType"] is not None else None
            )
        if "webhookId" in obj:
...
class v1Webhook(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1Webhook":
        ...
        if "triggers" in obj:
            kwargs["triggers"] = (
                [v1Trigger.from_json(x) for x in obj["triggers"]]
                if obj["triggers"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "triggers" in vars(self):
            out["triggers"] = (
                None if self.triggers is None else [x.to_json(omit_unset) for x in self.triggers]
            )
        return out
...
class v1WorkloadContainer(Printable):
    ...
    def from_json(cls, obj: Json) -> "v1WorkloadContainer":
        ...
        if "checkpoint" in obj:
            kwargs["checkpoint"] = (
                v1CheckpointWorkload.from_json(obj["checkpoint"])
                if obj["checkpoint"] is not None
                else None
            )
        if "training" in obj:
            kwargs["training"] = (
                v1MetricsWorkload.from_json(obj["training"])
                if obj["training"] is not None
                else None
            )
        if "validation" in obj:
            kwargs["validation"] = (
                v1MetricsWorkload.from_json(obj["validation"])
                if obj["validation"] is not None
                else None
            )
        return cls(**kwargs)
    ...
    def to_json(self, omit_unset: bool = False) -> typing.Dict[str, typing.Any]:
        ...
        if not omit_unset or "validation" in vars(self):
            out["validation"] = (
                None if self.validation is None else self.validation.to_json(omit_unset)
            )
        return out
...
def get_CompareTrials(
    ...
    *,
    ...
    _params = {
        ...
        "timeSeriesFilter.doubleRange.gt": dump_float(timeSeriesFilter_doubleRange_gt)
        if timeSeriesFilter_doubleRange_gt is not None
        else None,
        "timeSeriesFilter.doubleRange.gte": dump_float(timeSeriesFilter_doubleRange_gte)
        if timeSeriesFilter_doubleRange_gte is not None
        else None,
        "timeSeriesFilter.doubleRange.lt": dump_float(timeSeriesFilter_doubleRange_lt)
        if timeSeriesFilter_doubleRange_lt is not None
        else None,
        "timeSeriesFilter.doubleRange.lte": dump_float(timeSeriesFilter_doubleRange_lte)
        if timeSeriesFilter_doubleRange_lte is not None
        else None,
            ...
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_ExpMetricNames", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1ExpMetricNamesResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_ExpMetricNames", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_GetMetrics", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1GetMetricsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_GetMetrics", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_GetTrainingMetrics", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1GetTrainingMetricsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_GetTrainingMetrics", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
...
def get_GetTrialMetricsByCheckpoint(
    ...
    *,
    ...
    _params = {
        ...
        "trialSourceInfoType": trialSourceInfoType.value
        if trialSourceInfoType is not None
        else None,
    }
    _resp = session._do_request(
        method="GET",
    ...
    *,
    ...
    if _resp.status_code == 200:
        try:
            ...
            raise APIHttpStreamError(
                "get_GetTrialProfilerAvailableSeries",
                runtimeStreamError(message="ChunkedEncodingError"),
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_GetTrialProfilerMetrics", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1GetTrialProfilerMetricsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_GetTrialProfilerMetrics", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
...
def get_GetTrialWorkloads(
    ...
    *,
    ...
    _params = {
        ...
        "group": group,
        "includeBatchMetrics": str(includeBatchMetrics).lower()
        if includeBatchMetrics is not None
        else None,
        "limit": limit,
        "metricType": metricType.value if metricType is not None else None,
        "offset": offset,
        "orderBy": orderBy.value if orderBy is not None else None,
        "removeDeletedCheckpoints": str(removeDeletedCheckpoints).lower()
        if removeDeletedCheckpoints is not None
        else None,
        "sortKey": sortKey,
    }
    _resp = session._do_request(
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_GetValidationMetrics", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1GetValidationMetricsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_GetValidationMetrics", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_MasterLogs", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1MasterLogsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_MasterLogs", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_MetricBatches", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1MetricBatchesResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_MetricBatches", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_TaskLogs", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1TaskLogsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_TaskLogs", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_TaskLogsFields", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1TaskLogsFieldsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_TaskLogsFields", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_TrialLogs", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1TrialLogsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_TrialLogs", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_TrialLogsFields", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1TrialLogsFieldsResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_TrialLogsFields", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_TrialsSample", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1TrialsSampleResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_TrialsSample", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
    ...
    if _resp.status_code == 200:
        try:
            for _line in _resp.iter_lines(chunk_size=1024 * 1024):
                ...
                if "error" in _j:
                    raise APIHttpStreamError(
                        "get_TrialsSnapshot", runtimeStreamError.from_json(_j["error"])
                    )
                yield v1TrialsSnapshotResponse.from_json(_j["result"])
        except requests.exceptions.ChunkedEncodingError:
            raise APIHttpStreamError(
                "get_TrialsSnapshot", runtimeStreamError(message="ChunkedEncodingError")
            )
        return
