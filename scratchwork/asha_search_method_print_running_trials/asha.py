...
class ASHASearchMethod(searcher.SearchMethod):
    ...
    def initial_operations(
        ...
        self._print_num_running_trials(searcher_state, "initial operations")
    ...
    def on_validation_completed(
        ...
        self._print_num_running_trials(searcher_state, "validation completed")
    ...
    def on_trial_closed(
        ...
        self._print_num_running_trials(searcher_state, "trial closed")
    ...
    def on_trial_exited_early(
        ...
        self._print_num_running_trials(searcher_state, "early exit")
        self.asha_search_state.pending_trials -= 1
    ...
    def progress(self, searcher_state: searcher.SearcherState) -> float:
        self._print_num_running_trials(searcher_state, "progress")
    ...
    def _print_num_running_trials(
        self, searcher_state: searcher.SearcherState, method_name: str
    ) -> None:
        num_running_trials = len(
            searcher_state.trials_created - searcher_state.trials_closed - searcher_state.failures
        )
        logging.info(f"Num running trials ({method_name}): {num_running_trials}")
